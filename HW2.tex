...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{trap.points} \hlkwb{<-} \hldef{a} \hlopt{+} \hlnum{0}\hlopt{:}\hlnum{100}\hlopt{*}\hldef{(delta.x)}
\hldef{vector.areas} \hlkwb{<-} \hldef{delta.x}\hlopt{*}\hldef{(}\hlkwd{integrand}\hldef{(trap.points))} \hlcom{#vector that the integrand function returns}
\hldef{(trap.area} \hlkwb{<-} \hldef{(}\hlnum{1}\hlopt{/}\hlnum{2}\hldef{)}\hlopt{*}\hldef{vector.areas[}\hlnum{1}\hldef{]} \hlopt{+} \hlkwd{sum}\hldef{(vector.areas[}\hlnum{2}\hlopt{:}\hlnum{100}\hldef{])} \hlopt{+} \hldef{(}\hlnum{1}\hlopt{/}\hlnum{2}\hldef{)}\hlopt{*}\hldef{vector.areas[}\hlnum{101}\hldef{])}
\end{alltt}
\begin{verbatim}
## [1] 8.6664
\end{verbatim}
...
\hldef{riemann.sums} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{fnct}\hldef{,}                        \hlcom{# function to integrate}
  ...
  \hlcom{# Compute Area}
  \hlcom{######################################}
  \hldef{(delta.x} \hlkwb{<-} \hldef{(b}\hlopt{-}\hldef{a)}\hlopt{/}\hldef{n.rect)} \hlcom{#set a delta x based on a,b, and number of rectangles}
  ...
  \hldef{\}}\hlkwa{else if}\hldef{(method} \hlopt{==} \hlsng{"Trapezoidial"}\hldef{)\{}
    \hldef{trap.points} \hlkwb{<-} \hldef{a} \hlopt{+} \hlnum{0}\hlopt{:}\hlnum{100}\hlopt{*}\hldef{(delta.x)}
    \hldef{vector.areas} \hlkwb{<-} \hldef{delta.x}\hlopt{*}\hldef{(}\hlkwd{integrand}\hldef{(trap.points))}
    \hldef{(area} \hlkwb{<-} \hldef{(}\hlnum{1}\hlopt{/}\hlnum{2}\hldef{)}\hlopt{*}\hldef{vector.areas[}\hlnum{1}\hldef{]} \hlopt{+} \hlkwd{sum}\hldef{(vector.areas[}\hlnum{2}\hlopt{:}\hlnum{100}\hldef{])} \hlopt{+} \hldef{(}\hlnum{1}\hlopt{/}\hlnum{2}\hldef{)}\hlopt{*}\hldef{vector.areas[}\hlnum{101}\hldef{])}
...
\end{verbatim}
\begin{alltt}
\hlcom{#=8.7464 for Left, =8.5864 for Right, =8.6668 for Midpoint, =8.6664 for Trapezoidial}
\hlcom{######################################}
